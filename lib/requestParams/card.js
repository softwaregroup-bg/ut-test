...
module.exports = {
    addProductParams: function(context, productContext, productName, isActive) {
        return {
            product: {
                ...
                code: productContext(context).code,
    ...
    updateApplicationStateParams: function(context, applicationContext, customerName, personName) {
        const application = applicationContext(context).application[0] || applicationContext(context).application;
        return {
            application: {
                applicationId: application.applicationId,
                batchId: application.batchId || null,
                issuingBranchId: application.issuingBranchId || null,
                customerName: customerName || customerConstants.FIRSTNAME + ' ' + customerConstants.LASTNAME,
                customerNumber: application.customerNumber,
                customerId: application.customerId || null,
                holderName: application.holderName,
                personName: personName || customerConstants.FIRSTNAME + ' ' + customerConstants.LASTNAME,
                personNumber: application.personNumber,
                productId: application.productId,
                typeId: application.typeId,
                targetBranchId: application.targetBranchId || null,
                reasonId: application.reasonId || null,
                comments: application.comments || null,
                makerComments: application.makerComments || null
            },
            account: [{
                accountLinkId: applicationContext(context).account[0].accountLinkId,
    ...
    fetchProductParams: function(context, productContext, isActive = null, orderBy) {
        return {
