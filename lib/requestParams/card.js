...
module.exports = {
    ...
    addBinParams: function(context, binContextParams, randomBin) {
        return {
            bin: {
                bin: randomBin || null,
                description: binContextParams(context).description || null
            }
        };
    },
    getBinParams: function(context, binContextParams, randomBin, description, isActive) {
        return {
            bin: {
                binId: binContextParams(context).bin.binId,
                bin: randomBin,
