...
module.exports = {
    ...
    validateAddAccount: function(result) {
        const schema = joi.object().keys({
            ...
            accountActions: joi.array().items(joi.object().keys({
                accountId: joi.string(),
                productActionId: joi.number(),
                productAction: joi.string()
            }))
        }).required();
    ...
    validateEditAccount: function(result) {
        const schema = joi.object().keys({
            ...
            unapprovedAccountActions: joi.array()
        }).required();
        return joi.validate(result, schema, {abortEarly: false});
    },
    /**
