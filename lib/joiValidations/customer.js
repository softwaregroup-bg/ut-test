...
const getCustomerResultSchema = joi.object().keys({
    ...
    isEnabled: joi.number().valid(0, 1),
...
module.exports = {
    ...
    validateAddCustomer: function(result) {
        return joi.validate(result, getCustomerResultSchema, {abortEarly: false});
    },
    /**
     * @param {object}  result - result to validate (result.document)
     * @return {joiObject} - joiValidation
     */
    validateAddCustomerDocument: function(result) {
    ...
    validateAddOrganization: function(result) {
        const schema = joi.object().keys({
            ...
            updatedBy: joi.string().allow(null),
            rejectReason: joi.string().allow(null),
            isNew: joi.boolean().allow(1, '1', 0, '0'),
            ...
            description: joi.string().allow(null),
            isOwn: joi.boolean().allow(0, 1, '0', '1'),
            residenceCountryId: joi.number().allow(null),
            udf: joi.any().allow(null),
            createdBy: joi.string().allow(null),
            createdOn: joi.date().allow(null),
            activity: joi.string().allow('').allow(null)
        }).required();
        return joi.validate(result, schema, {abortEarly: false});
    },
    /**
    ...
    validateFetchDeletedKyc: function(result) {
        const schema = joi.object().keys({
            kyc: joi.array().items(joi.object().keys({
                kycId: joi.number().integer().allow(null).required(),
                description: joi.string().required(),
                display: joi.string().required(),
                customerType: joi.string().required(),
                organizationName: joi.string().required()
    ...
    validateGetPerson: function(result, firstName) {
        const schema = joi.object().keys({
            ...
            countryOfBirthId: joi.number().allow(null),
            residenceCountryId: joi.number().allow(null),
    ...
    vaidateGetOrganizationInfo: function(result) {
        const schema = joi.object().keys({
            ...
            cbsName: joi.string().allow(null),
            countryId: joi.number().allow(null),
            isNew: joi.boolean().allow(1, 0, '1', '0'),
    ...
    validateGetVisibleFor: function(result, orgActorId, orgName) {
        const schema = joi.object().keys({
            actorId: [joi.string().valid(orgActorId).required(), joi.number().valid(orgActorId).required()],
            organizationName: joi.string().valid(orgName),
    ...
    */
    validateFetchCustomers: function(result, statusId, stateId, firstName, lastName) {
        let validateStateId = joi.string().allow(null).allow('');
        let validateStatusId = joi.string().allow(null).allow('');
        let validateFirstName = joi.string().allow(null).allow('').required();
        let validateLastName = joi.string().allow(null).allow('').required();
        let reg, reg1;
        if (statusId) {
    ...
    validateFetchDeletedOrganization: function(result) {
        const schema = joi.array().items(joi.object().keys({
            actorId: joi.string().required(),
            organizationName: joi.string().allow('').allow(null)
        }));
    ...
    validateFetchOrganizationGraph: function(result) {
        const schema = joi.array().items(joi.object().keys({
            ...
            parents: joi.number().allow('').allow(null)
        }));
        return schema.validate(result);
    },
    // validate search
    ...
    validateFetchCountry: function(result) {
        const schema = joi.array().items(joi.object().keys({
            ...
            phoneLength: joi.number().allow(null).required()
        }));
        return schema.validate(result);
    },
    /**
    ...
    validateAddReferral: function(result) {
        const schema = joi.array().items(joi.object().keys({
            ...
            rejectReason: joi.string().allow(null),
            isNew: joi.boolean().allow(0, 1, '0', '1'),
            customerNumber: joi.number().allow(null),
