...
module.exports = {
    ...
    validateGetCustomer: function(result) {
        var schema = joi.object().keys({
            actorId: joi.string().allow(null).required(),
            frontEndRecordId: joi.string().allow(null),
            customerNumber: joi.string().allow(null),
            customerTypeId: joi.string().required(),
            kycId: joi.number().allow(null),
    ...
    validateGetAddress: function(result, addressValue, addressType) {
        var schema = joi.object().keys({
            ...
            addressZone1: joi.string().allow(null).required(),
            addressZone1Id: joi.number().allow(null).required(),
            addressZone2: joi.string().allow(null).required(),
            addressZone2Id: joi.number().allow(null).required(),
            addressZone3: joi.string().allow(null).required(),
            addressZone3Id: joi.number().allow(null).required(),
            addressZone4: joi.string().allow(null).required(),
            addressZone4Id: joi.number().allow(null).required(),
            isDeleted: joi.boolean().allow(0, 1, '0', '1'),
            updatedBy: joi.string().allow(null).required(),
            updatedOn: joi.string().allow(null).required()
        }).required();
    ...
    * @param {arr}  result - result to validate (result.customerPhone)
    ...
    validateAddAddress: function(result) {
        var schema = joi.array().items(joi.object().keys({
            ...
            addressZone4Id: joi.number().allow(null).required(),
            value: joi.string().required(),
            addressUnapprovedId: joi.string().allow(null).required(),
            isDeleted: joi.boolean().allow(0, 1, '0', '1'),
            updatedBy: joi.string().allow(null).required(),
            updatedOn: joi.string().allow(null).required()
        }));
