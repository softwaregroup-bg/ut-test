...
module.exports = {
    ...
    validateAddLoanApplication: function(result) {
        var schema = joi.object().keys({
            collaterals: joi.any().optional(),
            guarantors: joi.any().optional(),
            ...
            repaymentTypeId: joi.alternatives([joi.number(), joi.string()]).allow(null),
    ...
    validateGetLoanApplication: function(result) {
        var schema = joi.object().keys({
            ...
            customerAccounts: joi.array().optional(),
            ...
            stateId: joi.alternatives([joi.number(), joi.string()]).allow(['', null]),
            charges: joi.array().allow(['', null]),
            applicationCharges: joi.string().allow([null, '']),
    ...
    validateGetLoanCurrency: function(result) {
        var schema = joi.array().items(joi.object({
            ...
            countryId: joi.number().allow(null),
            parentItemNameId: joi.number().allow(null)
        }));
    ...
    validateGetActivityDashboard: function(result) {
        var schema = joi.object().keys({
            isBM: joi.bool().optional(),
            isHQ: joi.bool().optional(),
            isPM: joi.bool().optional(),
