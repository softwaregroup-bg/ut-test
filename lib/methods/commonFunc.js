    ...
    */
    ...
    compareOrderString: function(result, property, isASC) {
        ...
        for (i = 0, len = result.length - 1; i < len; i += 1) {
            // compares the asc and desc order according to javascript localeCompare, but exclude strings that contains '-', because ms sql and javascript sorts special symbols differently
    ...
    encrypt: function(value, key) {
        ...
        const cipher = crypto.createCipher('aes-256-ctr', encryptionKeyBuffer);
