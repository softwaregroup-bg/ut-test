...
module.exports = {
    ...
    requestPIN: function(stepname, contextStep) {
        return commonFunc.createStep('user.pin.requestReset', stepname, context => userParams.requestPINParams(context, contextStep),
        (result, assert) => {
