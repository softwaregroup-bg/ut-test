...
module.exports = {
    ...
    editProduct: function(stepname, contextStep) {
        return commonFunc.createStep('product.product.edit', stepname, context => productParams.editProductParams(context, contextStep),
        (result, assert) => {
    ...
    rejectProduct: function(stepname, contextStep, rejectReason) {
        return commonFunc.createStep('product.product.reject', stepname, context => productParams.rejectProductParams(context, contextStep, rejectReason),
        (result, assert) => {
