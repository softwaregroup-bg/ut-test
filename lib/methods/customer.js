...
module.exports = {
    ...
    addOrganization: function(stepname, contextStep, organizationName) {
        ...
        (result, assert) => {
            ...
            assert.equals(result['organization.info'][0].isEnabled, 1, 'return isEnabled 1');
        });
    },
    ...
    removeOrganization: function(stepname, contextStep) {
        return commonFunc.createStep('customer.organization.remove', stepname, context => customerParams.removeOrganizationParams(context, contextStep),
        (result, assert) => {
