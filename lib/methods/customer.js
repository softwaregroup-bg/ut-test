...
module.exports = {
    ...
    editKyc: function(stepname, contextStep, kycDescription) {
        ...
        (result, assert) => {
            // assert.equals(customerJoiValidation.validateEditKyc(result.kyc).error, null, 'Return all details after adding a kyc');
        });
    },
    ...
    fetchKyc: function(stepname, contextStep) {
        ...
        (result, assert) => {
            // assert.equals(customerJoiValidation.validateAddKyc(result.kyc).error, null, 'Return all details after fetching kyc');
        });
    },
    changeKycStatus: function(stepname, contextStep, isActive) {
        ...
        (result, assert) => {
            // assert.equals(customerJoiValidation.validateChangeKycStatus(result).error, null, 'Return all details after changing kyc status');
        });
    },
    deleteKyc: function(stepname, contextStep) {
        ...
        (result, assert) => {
            // assert.equals(customerJoiValidation.validateDeleteKyc(result).error, null, 'Return all details after delete kyc');
        });
    },
    ...
    listKycAttribute: function(stepname, contextStep) {
        return commonFunc.createStep('customer.kycAttribute.list', stepname, context => customerParams.listKycAttributeParams(context, contextStep),
        (result, assert) => {
            assert.equals(customerJoiValidation.validateListKycAttribute(result.kycAttributes).error, null, 'Return all details for kyc attributes');
        });
    }
};
