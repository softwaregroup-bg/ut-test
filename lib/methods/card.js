...
module.exports = {
    ...
    fetchBrand: function(stepname, getType) {
        return commonFunc.createStep('card.brand.fetch', stepname, context => getType(context),
        (result, assert) => {
<<<<<<< HEAD
            assert.equals(cardJoiValidation.validateFetchCardType(result.cardBrand[0]).error, null, 'return card brands');
=======
            assert.equals(cardJoiValidation.validateFetchCardBrand(result.cardBrand[0]).error, null, 'return card brands');
>>>>>>> 94c002b925e35ebdf1e1a9210a1cca1c822c77f1
        });
    },
    ...
    fetchPartners: function(stepname, getIssuerTypes) {
        ...
        (result, assert) => {
            assert.equals(cardJoiValidation.validateFetchPartners(result.partner[0]).error, null, 'return partners');
        });
    },
