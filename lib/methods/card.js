...
module.exports = {
    ...
    editBatch: function(stepname, contextStep) {
        return commonFunc.createStep('card.batch.statusUpdate', stepname, context => cardParams.editBatchParams(context, contextStep),
        (result, assert) => {
            // console.log(result);
        });
    }
