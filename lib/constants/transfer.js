...
module.exports = {
    constants: function() {
        return {
            ...
            PUSH: 'push',
            STRINGVALUE: 'test1',
            NUMBERVALUE: 9999999999999,
            NUMBERINTEGER: 'number.integer',
            PORTPARAMSVALIDATION: 'port.paramsValidation',
            IVALIDTRANSFERTYPE: 'transfer.invalidTransferType',
            INSUFFICIENTFUNDS: 'transfer.insufficientFunds',
            INVALIDISSUER: 'transfer.invalidIssuer',
            INACTIVEACCOUNT: 'transfer.inactiveAccount',
            INVALIDACCOUNT: 'transfer.invalidAccount',
            ATMNEXTID: 'atm.nextId',
            ALLOWONLY: 'any.allowOnly',
            REQUESTERROR: 'RequestError',
            TRANSFERNOTFOUND: 'transfer.notFound',
